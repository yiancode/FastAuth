...
import static com.yiancode.fastauth.config.AuthDefaultSource.TWITTER;
import static com.yiancode.fastauth.utils.GlobalAuthUtils.generateTwitterSignature;
import static com.yiancode.fastauth.utils.GlobalAuthUtils.urlEncode;
...
public class AuthTwitterRequest extends AuthDefaultRequest {
    ...
    public AuthToken getRequestToken() {
        ...
        httpHeader.add("User-Agent", "'FastAuth' HTTP Client Simple-Http");
