...
import com.yiancode.fastauth.utils.AuthChecker;
...
public class AuthAlipayRequest extends AuthDefaultRequest {
    ...
    /**
     * @see AuthAlipayRequest#AuthAlipayRequest(com.yiancode.fastauth.config.AuthConfig, java.lang.String)
    ...
    /**
     * @see AuthAlipayRequest#AuthAlipayRequest(com.yiancode.fastauth.config.AuthConfig, java.lang.String, com.yiancode.fastauth.cache.AuthStateCache)
     * @deprecated 请使用带有"alipayPublicKey"参数的构造方法
     */
    @Deprecated
    ...
    /**
     * @see AuthAlipayRequest#AuthAlipayRequest(com.yiancode.fastauth.config.AuthConfig, java.lang.String, com.yiancode.fastauth.cache.AuthStateCache, java.lang.String, java.lang.Integer)
     * @deprecated 请使用带有"alipayPublicKey"参数的构造方法
     */
    @Deprecated
     ...
     * @see AuthAlipayRequest#AuthAlipayRequest(com.yiancode.fastauth.config.AuthConfig)
     */
     ...
     * @param config          公共的OAuth配置
     * @param alipayPublicKey 支付宝公钥
     * @see AuthAlipayRequest#AuthAlipayRequest(com.yiancode.fastauth.config.AuthConfig, com.yiancode.fastauth.cache.AuthStateCache)
     */
     ...
     * @param config          公共的OAuth配置
     * @param alipayPublicKey 支付宝公钥
     * @see AuthAlipayRequest#AuthAlipayRequest(com.yiancode.fastauth.config.AuthConfig, com.yiancode.fastauth.cache.AuthStateCache, java.lang.String, java.lang.Integer)
     */
