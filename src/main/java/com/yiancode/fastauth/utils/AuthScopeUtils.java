...
import com.yiancode.fastauth.enums.scope.AuthScope;
...
public class AuthScopeUtils {
    ...
    /**
     * 获取 {@link com.yiancode.fastauth.enums.scope.AuthScope} 数组中所有的被标记为 {@code default} 的 scope
     *
     * @param scopes scopes
     * @return List
     */
    ...
    /**
     * 从 {@link com.yiancode.fastauth.enums.scope.AuthScope} 数组中获取实际的 scope 字符串
     *
     * @param scopes 可变参数，支持传任意 {@link com.yiancode.fastauth.enums.scope.AuthScope}
     * @return List
     */
