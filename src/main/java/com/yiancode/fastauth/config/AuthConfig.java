...
public class AuthConfig {
     ...
     * {@link com.yiancode.fastauth.request.AuthDefaultRequest#login(AuthCallback)} 将不会校验 {@code state} 的合法性。
     * <p>
     * 使用场景：当且仅当使用自实现 {@code state} 校验逻辑时开启
     * <p>
     * 以下场景使用方案仅作参考：
     * 1. 授权、登录为同端，并且全部使用 FastAuth 实现时，该值建议设为 {@code false};
     ...
     * 该方案主要为了解决以下类似场景的问题：
     *
     * @see <a href="https://github.com/justauth/FastAuth/issues/83">https://github.com/justauth/FastAuth/issues/83</a>
     * @since 1.15.6
     */
     ...
     * {@link com.yiancode.fastauth.utils.AuthChecker#checkConfig(AuthConfig, AuthSource)} 将不会校验 {@code redirectUri} 的合法性。
     *
     * @since 1.16.1
     */
